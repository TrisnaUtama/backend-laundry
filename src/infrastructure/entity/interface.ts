...
import type { Address, Employee, OTP, User, Ratting, Service, Item, Item_Type, Order, Payment } from "@prisma/client";

export interface IUser {
    getAll: () => Promise<User[]>
    getOne: (id : string) => Promise<User | null>
    create: (data : Omit<User, "user_id">) => Promise<User>
...
export interface IOTP {
    getAll: () => Promise<OTP | null>
    getOne: (id : string) => Promise<OTP | null>
    create: (data : Omit<OTP, "otp_id">) => Promise<Address>
}
